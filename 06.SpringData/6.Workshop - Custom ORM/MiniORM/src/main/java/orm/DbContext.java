...
public interface DbContext<E> {
    ...
    E findFirst(Class<E> clazz, String where) throws SQLException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException;

    void createTable(Class<E> clazz) throws SQLException;
}
